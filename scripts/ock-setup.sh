...
BASEDIR=$(pwd)
TMPPDIR="tmp-ock"
PINFILE=${BASEDIR}/${TMPPDIR}/pin.txt
...
cat > ${TMPPDIR}/unsetvars << UNSETSCRIPT
# unset debug vars, just 'source ${TMPPDIR}/debugvars'
unset TMPPDIR
unset OPENSSL_CONF
